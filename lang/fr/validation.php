...
return [
    ...
    */
    ...
    'match_current_password' => 'Le champ :attribute ne correspond pas au mot de passe stocké.',
    'hex_color' => 'Le champ :attribute doit être un code couleur hexadécimal valide.',
    'csv' => [
        'line' => 'Le fichier a une erreur ligne :line.',
        'file' => 'Le fichier doit être un fichier csv valide, avec \';\' comme séparateur.',
        'format' => 'Le fichier doit respecter le format souhaité.',
    ],
    'address' => [
        "lat_lng" => "Utilisez l'api Google pour saisir votre adresse."
    ],
